...
Der Job-Tracker überwacht den Gesamtfortschritt eines Map-Reduce-Schrittes, generiert die Map- und Reduce-Tasks und kümmert sich um die Ein- und Ausgabe.
...
Die Jaccard-Distanz ist ein Abstandsmaß, dass die Ähnlichkeit zwischen Mengen angibt. Dabei sind zwei Mengen einander ähnlicher, je mehr Elemente sie gemeinam haben. Die Jaccard-Distanz von einer Menger zu sich selbst ist Null.
