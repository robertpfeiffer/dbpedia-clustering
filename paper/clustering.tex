...
Die Daten werden als RDF-Tripel der Form $(Subjekt, Attribut, Wert)$ in der DBPedia gehalten (z.B. $(Berlin, populationTotal, 3429300)$).
...
Die Laufzeitabschätzung geht von einer konstanten Anzahl von Iterationen bis zur Konvergenz aus. Um diesen Abstand zu bestimmen wurde gemessen, wie stark sich Cluster in jeder Iteration verändern. Dazu wurden drei Testfälle mit 35.000 Subjekten und zwischen 50 ind 150 Clustern betrachtet.
\begin{figure}[!ht]
\centering
...
\end{figure}
Wie aus Abbildung \ref{fig:iteratons} hervorgeht, nähern sich die Cluster schnell einem relativ stabilen Zustand an.
